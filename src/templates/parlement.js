        ...
        <div className="grid grid-cols-2  main m-auto mt-20">
          <article className="flex gap-20 col">
            ...
            <article className="flex flex-col gap-5">
              ...
              {personne.commision && personne.commision.commision && (
                <h4 className="p-2 rounded min-width head font-black text-white">
                   {personne.commision.commision}
                </h4>
              )}
              <h4 className="p-2 rounded w-full headbleu font-black text-white">circonscription de : {personne.circonscription.nom}</h4>
              {attach && (
