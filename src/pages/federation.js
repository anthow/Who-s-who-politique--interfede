...
export const query = graphql`
  {
    ...
    mrMembers: allDatoCmsPersonne(
      ...
      filter: {
        ...
        statut: {elemMatch: {nom: {eq: "Fédération WB"}}}
        parti: {nom: {eq: "MR"}}
      }
    ) {
      edges {
...
export const Head = () => (
  <>
    <title>Fédération WB - Who's Who politique</title>
    <meta name="description" content="Découvrez les membres de la fédération WB." />
  </>
)
